...
<head>
    ...
    <link rel="stylesheet" href="../css/tailwind-dashboard.css">
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <img src="../assets/LOGO-FORBASI.png" alt="FORBASI Logo" class="sidebar-logo">
            <div class="sidebar-brand">
                <span class="sidebar-title">FORBASI</span>
                <span class="sidebar-subtitle">Pengurus Besar</span>
            </div>
        </div>
        ...
        <nav class="sidebar-nav">
            <ul class="nav-menu">
                <li class="nav-item">
                    <a href="#kta_applications_section" class="nav-link active" data-section="kta_applications_section">
                        <i class="fas fa-file-invoice"></i>
                        <span>Pengajuan KTA</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#saldo_overview_section" class="nav-link" data-section="saldo_overview_section">
                        <i class="fas fa-wallet"></i>
                        <span>Ringkasan Saldo</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#view_issued_kta_section" class="nav-link" data-section="view_issued_kta_section">
                        <i class="fas fa-id-card"></i>
                        <span>KTA Diterbitkan</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#view_members_section" class="nav-link" data-section="view_members_section">
                        <i class="fas fa-users"></i>
                        <span>Lihat Anggota</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#pb_kta_config_section" class="nav-link" data-section="pb_kta_config_section">
                        <i class="fas fa-cogs"></i>
                        <span>Konfigurasi KTA</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="manage_lisensi.php" class="nav-link">
                        <i class="fas fa-certificate"></i>
                        <span>Lisensi Pelatih & Juri</span>
                    </a>
                </li>
                <li class="nav-item has-submenu">
                    <a href="#" class="nav-link" onclick="toggleSubmenu(this.parentElement)">
                    ...
                    <ul class="submenu">
                        <li class="nav-item">
                            <a href="#kejurnas_section" class="nav-link" data-section="kejurnas_section">
                                <i class="fas fa-medal"></i>
                                <span>Pendaftaran Kejurnas</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#competition_reregistrations_section" class="nav-link" data-section="competition_reregistrations_section">
                ...
                <li class="nav-item">
                    <a href="#admin_profile_section" class="nav-link" data-section="admin_profile_section">
                        <i class="fas fa-user-circle"></i>
                        <span>Profil Admin</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#activity_log_section" class="nav-link" data-section="activity_log_section">
    ...
    <main class="main-content" id="main-content">
        <header class="main-header">
            <div class="header-left">
                ...
                <div class="header-title">
                    <h1>Dashboard Pengurus Besar</h1>
        ...
        <div class="content-wrapper">
            <!-- KTA Applications Section -->
            <section class="section active" id="kta_applications_section">
                ...
                <!-- Status Cards -->
                <div class="stats-grid" id="kta-status-cards-container">
                    <div class="stat-card" data-status-filter="approved_pengda">
                        <div class="stat-icon primary">
                            <i class="fas fa-check-circle"></i>
                        </div>
                        <div class="stat-info">
                            <p class="stat-label">Disetujui Pengda</p>
                            <p class="stat-value" id="count-approved_pengda">0</p>
                        </div>
                    </div>
                    <div class="stat-card" data-status-filter="approved_pb">
                        <div class="stat-icon success">
                            <i class="fas fa-check-double"></i>
                        </div>
                        <div class="stat-info">
                            <p class="stat-label">Disetujui PB</p>
                            <p class="stat-value" id="count-approved_pb">0</p>
                        </div>
                    </div>
                    <div class="stat-card" data-status-filter="rejected_pb">
                        <div class="stat-icon danger">
                            <i class="fas fa-times-circle"></i>
                        </div>
                        <div class="stat-info">
                            <p class="stat-label">Ditolak PB</p>
                            <p class="stat-value" id="count-rejected_pb">0</p>
                        </div>
                    </div>
                    <div class="stat-card" data-status-filter="kta_issued">
                        <div class="stat-icon secondary">
                            <i class="fas fa-id-card"></i>
                        </div>
                        <div class="stat-info">
                            <p class="stat-label">KTA Diterbitkan</p>
                            <p class="stat-value" id="count-kta_issued">0</p>
                        </div>
                    </div>
                    <div class="stat-card" data-status-filter="pending_pengda_resubmit">
                        <div class="stat-icon warning">
                            <i class="fas fa-redo"></i>
                        </div>
                        <div class="stat-info">
                            <p class="stat-label">Menunggu Pengajuan Ulang</p>
                            <p class="stat-value" id="count-pending_pengda_resubmit">0</p>
                        </div>
                    </div>
                    <div class="stat-card" data-status-filter="">
                        ...
                        <div class="stat-info">
                            ...
                            <p class="stat-value" id="count-total_applications">0</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="filter-grid">
                            <div class="form-group">
                                <label class="form-label" for="ktaProvinceFilter">Provinsi</label>
                                <select id="ktaProvinceFilter" class="form-control form-select">
                            ...
                            <div class="form-group">
                                <label class="form-label" for="ktaCityFilter">Kota/Kabupaten</label>
                                <select id="ktaCityFilter" class="form-control form-select" disabled>
                                    <option value="">Semua Kota/Kabupaten</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="ktaSearchInput">Cari</label>
                                <input type="text" id="ktaSearchInput" class="form-control" placeholder="Klub, PJ, Barcode ID...">
                            </div>
                        </div>
                        <div class="filter-actions">
                            <button type="button" class="btn btn-primary" onclick="loadKtaTable(1)">
                                <i class="fas fa-search"></i> Terapkan Filter
                            </button>
                            <button type="button" class="btn btn-secondary" onclick="resetKtaTableFilters()">
                ...
                <div class="table-container mt-4">
                    <div id="kta-applications-table-container">
                        <div class="loading">
                            ...
                            <p>Memuat pengajuan KTA...</p>
                        </div>
                    </div>
                </div>
            </section>

            <!-- Saldo Overview Section -->
            <section class="section" id="saldo_overview_section">
                <div class="section-header">
                    <h2 class="section-title">
                        <i class="fas fa-wallet"></i>
                        Ringkasan Saldo Keuangan PB
                    </h2>
                </div>
                ...
                <div class="balance-grid">
                    <div class="balance-card income">
                        ...
                        <p class="balance-label">Saldo Masuk</p>
                        <p class="balance-value" id="total-saldo-masuk-display">Rp 0</p>
                        <p class="balance-description">Total pembayaran dari pengguna</p>
                    </div>
                    <div class="balance-card expense">
                        <div class="balance-icon">
                            <i class="fas fa-arrow-up"></i>
                        </div>
                        <p class="balance-label">Saldo Keluar</p>
                        <p class="balance-value" id="total-saldo-keluar-display">Rp 0</p>
                        <p class="balance-description">Transfer ke Pengda dan Pengcab</p>
                    </div>
                    <div class="balance-card total">
                        <div class="balance-icon">
                            <i class="fas fa-wallet"></i>
                        </div>
                        <p class="balance-label">Total Saldo PB</p>
                        <p class="balance-value" id="total-saldo-display">Rp 0</p>
                        <p class="balance-description">Selisih saldo masuk dan keluar</p>
                    </div>
                    <div class="balance-card pending">
                        <div class="balance-icon">
                            <i class="fas fa-building"></i>
                        </div>
                        <p class="balance-label">Estimasi ke Pengda</p>
                        <p class="balance-value" id="estimate-to-pengda-display">Rp 0</p>
                        <p class="balance-description">Harus dibayarkan ke Pengda</p>
                    </div>
                    <div class="balance-card pending">
                        <div class="balance-icon">
                            <i class="fas fa-city"></i>
                        </div>
                        <p class="balance-label">Estimasi ke Pengcab</p>
                        <p class="balance-value" id="estimate-to-pengcab-display">Rp 0</p>
                        <p class="balance-description">Harus dibayarkan ke Pengcab</p>
                    </div>
                    <div class="balance-card pending">
                        <div class="balance-icon">
                            <i class="fas fa-code"></i>
                        </div>
                        <p class="balance-label">Estimasi ke Developer</p>
                        <p class="balance-value" id="estimate-to-developer-display">Rp 0</p>
                        <p class="balance-description">Harus dibayarkan ke Developer</p>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="filter-grid">
                            <div class="form-group">
                                <label class="form-label" for="saldoProvinceFilter">Provinsi</label>
                                <select id="saldoProvinceFilter" class="form-control form-select">
                                    <option value="">Semua Provinsi</option>
                                    <?php
                            ...
                            <div class="form-group">
                                <label class="form-label" for="saldoCityFilter">Kota/Kabupaten</label>
                                <select id="saldoCityFilter" class="form-control form-select">
                                    <option value="">Semua Kota/Kabupaten</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="saldoMonthFilter">Bulan</label>
                                <select id="saldoMonthFilter" class="form-control form-select">
                            ...
                            <div class="form-group">
                                <label class="form-label" for="saldoYearFilter">Tahun</label>
                                <select id="saldoYearFilter" class="form-control form-select">
                            ...
                            <div class="form-group">
                                <label class="form-label" for="saldoKTAStatusFilter">Status KTA</label>
                                <select id="saldoKTAStatusFilter" class="form-control form-select">
                        ...
                        <div class="filter-actions">
                            <button type="button" class="btn btn-primary" onclick="loadSaldoDataAndHistory()">
                                <i class="fas fa-search"></i> Terapkan Filter
                            </button>
                            <button type="button" class="btn btn-secondary" onclick="resetSaldoFilters()">
                                <i class="fas fa-sync"></i> Reset
                            </button>
                            <button type="button" class="btn btn-success" id="exportSaldoExcelBtn">
                ...
                <!-- Recap Payment Section -->
                <div class="card mt-4">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="fas fa-money-check-alt"></i>
                            Rekap Pembayaran PB ke Pengda/Pengcab
                        </h3>
                    </div>
                    <div class="card-body">
                        <div class="filter-grid">
                            <div class="form-group">
                                <label class="form-label" for="recapRecipientType">Pilih Penerima</label>
                                <select id="recapRecipientType" class="form-control form-select">
                            ...
                            <div class="form-group" id="recapRecipientSelectGroup" style="display:none;">
                                <label class="form-label" for="recapRecipientId">Pilih Entitas</label>
                                <select id="recapRecipientId" class="form-control form-select">
                                    <option value="">Pilih Entitas</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="recapPeriodType">Jenis Rekap</label>
                                <select id="recapPeriodType" class="form-control form-select">
                                    <option value="monthly">Bulanan</option>
                                    <option value="yearly">Tahunan</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="recapYear">Tahun Rekap</label>
                                <select id="recapYear" class="form-control form-select">
                                    <?php
                                        $current_year = date('Y');
                                        for ($y = $current_year; $y >= 2025; $y--) {
                                            echo '<option value="' . $y . '">' . $y . '</option>';
                            ...
                            <div class="form-group" id="recapMonthGroup">
                                <label class="form-label" for="recapMonth">Bulan Rekap</label>
                                <select id="recapMonth" class="form-control form-select">
                                    <?php
                                        $months = [
                                            1 => 'Januari', 2 => 'Februari', 3 => 'Maret', 4 => 'April',
                                            5 => 'Mei', 6 => 'Juni', 7 => 'Juli', 8 => 'Agustus',
                        ...
                        <div class="filter-actions">
                            <button type="button" class="btn btn-warning" id="openRecapPaymentModalBtn" disabled>
                                <i class="fas fa-coins"></i> Lakukan Pembayaran Rekap
                            </button>
                        </div>
                    </div>
                </div>
