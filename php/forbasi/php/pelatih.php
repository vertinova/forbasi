...
ini_set('error_log', __DIR__ . '/php_error_log_pelatih.txt');

require_once 'db_config.php';

// Check login
if (!isset($_SESSION['license_user_id']) || $_SESSION['license_role'] != 'pelatih') {
        ...
        if (empty($nama_lengkap) || empty($alamat) || empty($no_telepon) || empty($email)) {
            ...
            if (isset($_FILES['pas_foto']) && $_FILES['pas_foto']['error'] === UPLOAD_ERR_OK) {
                ...
                if ($file['size'] > $max_file_size) {
                    ...
                    $filename = 'pasfoto_' . $user_id . '_' . time() . '.' . $ext;
            ...
            if (isset($_FILES['bukti_transfer']) && $_FILES['bukti_transfer']['error'] === UPLOAD_ERR_OK) {
                ...
                if ($file['size'] > $max_file_size) {
                    ...
                    $ext = pathinfo($file['name'], PATHINFO_EXTENSION);
                    $filename = 'bukti_tf_' . $user_id . '_' . time() . '.' . $ext;
            ...
            if (isset($_FILES['surat_pengalaman']) && $_FILES['surat_pengalaman']['error'] === UPLOAD_ERR_OK) {
                ...
                if ($file['size'] > $max_file_size) {
                    ...
                    $ext = pathinfo($file['name'], PATHINFO_EXTENSION);
                    $filename = 'pengalaman_' . $user_id . '_' . time() . '.' . $ext;
            ...
            if (!empty($upload_errors)) {
                ...
                // Insert application
                $biaya = $event ? $event['biaya_pelatih'] : 750000;
                
                $insert_stmt = $conn->prepare("INSERT INTO license_applications 
                    (user_id, nama_lengkap, alamat, jenis_lisensi, no_telepon, email, pas_foto, bukti_transfer, surat_pengalaman, biaya_lisensi, status) 
                    VALUES (?, ?, ?, 'pelatih', ?, ?, ?, ?, ?, ?, 'pending')");
                
                $insert_stmt->bind_param("isssssssd", 
                    $user_id, 
                    $nama_lengkap, 
                    $alamat, 
                    $no_telepon, 
                ...
                if ($insert_stmt->execute()) {
                    ...
                    $response['message'] = "Pengajuan lisensi pelatih berhasil dikirim! Mohon tunggu proses verifikasi oleh PB FORBASI.";
                } else {
                    $response['message'] = "Terjadi kesalahan saat menyimpan data. Silakan coba lagi.";
...
<head>
    ...
    <title>Dashboard Pelatih - FORBASI</title>
    ...
    <style>
        :root {
            --primary: #00c853;
            --primary-dark: #009624;
            --primary-light: rgba(0, 200, 83, 0.15);
            --secondary: #1d3557;
            --accent: #ffd700;
            --danger: #ff5252;
            --dark-bg: #0a1628;
    ...
    <div class="main-content">
        ...
        <div class="welcome-card">
            <div class="welcome-header">
                ...
                <div class="welcome-text">
                    ...
                    <p>Ajukan lisensi pelatih dan pantau status pengajuan Anda</p>
                </div>
            </div>
        </div>
        ...
        <div class="event-card">
            ...
            <div class="event-price">
                <div class="label">Biaya Lisensi Pelatih</div>
                <div class="amount">Rp <?php echo number_format($event['biaya_pelatih'], 0, ',', '.'); ?></div>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="form-card" id="formSection">
            <div class="form-header">
                <h3><i class="fas fa-file-alt"></i> Form Pengajuan Lisensi</h3>
            </div>
            <div class="form-body">
                <form id="applicationForm" enctype="multipart/form-data">
                    ...
                    <div class="upload-section">
                        ...
                        <div class="form-group">
                            <label>Surat Keterangan Pengalaman Melatih <span class="required">*</span></label>
                            <div class="file-upload" id="upload-pengalaman">
                                ...
                                <div class="upload-text">Klik untuk upload</div>
                                <div class="file-info">JPG/PNG/PDF, Maks. 2MB - Dari sekolah/instansi terkait</div>
                                <div class="file-name"></div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="contact-box">
            ...
            <a href="https://wa.me/6282111543777?text=Halo%20Pak%20Tito%2C%20saya%20ingin%20bertanya%20tentang%20lisensi%20pelatih%20FORBASI" target="_blank" class="btn-whatsapp">
